    ...
    <div>
        ...
        <section>
            <p className="text white">
                ...
                <a className= "hyper-link red">NUS</a>). Physicist turned programmer, I am passionate about leveraging technology to solve real-world problems. 
            ...
            <p className='text white'>
                    ...
                    and my blog <a className="hyper-link red">here</a>.
            </p>
            <p className='text white'>
                In my free time, I enjoy gardening and reading books on a variety of topics, from science fiction to philosophy. 
                You can find my succulent collection, and my currated reading list in <a className="hyper-link red">my blog</a>.
            </p>
            <p className='text white'>
                I'm always eager to connect, so feel free to <a className="hyper-link red">reach out</a>!
            </p>
        </section>
    </div>
);
